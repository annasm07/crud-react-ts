...
describe('When the Favorites component is rendered', () => {
    const initialState ={
        preloadedState:{
            favorites: [{
                id: 1,
  ...
  test('Then Favorites of application should be in the document', () => {
    render(<BrowserRouter><Favorites /></BrowserRouter>, initialState);
    expect(screen.getByText(/Favortite/i)).toBeInTheDocument();
  });
});
